...
'Add record to database': 'Adicione um registro para o banco de dados',
...
'Codigocacaushow': 'Codigocacaushow',
...
'Enter a number between %(min)g and %(max)g': 'Informe um número entre %(min)g e %(max)g',
'Enter a value': 'Conloque um valor',
'Enter an integer between %(min)g and %(max)g': 'Informe um valor inteiro entre %(min)g e %(max)g',
'Enter date as %(format)s': 'Coloque a data no formato %(format)s',
'Entradaprodutoestoques': 'Entradaprodutoestoques',
'Errors': 'Erros',
...
'Group %(group_id)s deleted': 'Grupo %(group_id)s deletado',
...
'Id': 'Id',
'Id Entradaprodutoestoque': 'Id Entradaprodutoestoque',
'Id Produto': 'Id Produto',
'Id Tipounidade': 'Id Tipounidade',
'import': 'importar',
...
'Preencha este campo': 'Preencha este campo',
'Preface': 'Prefácio',
...
'Quantidade de Kits': 'Quantidade de Kits',
...
'Saidaprodutoestoques': 'Saidaprodutoestoques',
...
'Timestamp': 'Timestamp',
'Tipounidadedescricao': 'Tipounidadedescricao',
'Too short': 'Too short',
'Traceback': 'Traceback',
